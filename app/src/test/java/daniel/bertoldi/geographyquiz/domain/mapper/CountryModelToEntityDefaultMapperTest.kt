...
class CountryModelToEntityDefaultMapperTest {
    ...
    fun withBaseModelParams_asserCorrectEntityMapping() {
        ...
        Assertions.assertEquals(country.carInfo.side, actual.carRegulations.carSide)
        Assertions.assertEquals(country.carInfo.signs, actual.carRegulations.carSigns)
